  ...
  return (
    ...
    >
      ...
      <div className="text-slate-700 space-y-5 text-lg leading-relaxed">
        <p>
          No quadro geral a seguir encontram-se os temas abordados pelo <strong>Livro do Estudante</strong>, com as competências gerais e específicas da <strong>BNCC</strong>, as habilidades de Matemática desenvolvidas e sugestões de como articulá-las com o Projeto Coletivo dos jovens.
        </p>
        <p>
          A <strong>BNCC</strong> define dez competências a serem trabalhadas e desenvolvidas ao longo da Educação Básica. Cada uma delas engloba objetivos e habilidades que devem ser estimuladas no estudante. São elas:
        </p>
        <ol className="list-decimal list-inside space-y-1 pl-4">
          <li><strong>Conhecimento</strong></li>
          <li><strong>Pensamento científico, crítico e criativo</strong></li>
          <li><strong>Repertório cultural</strong></li>
          <li><strong>Comunicação</strong></li>
          <li><strong>Cultura digital</strong></li>
          <li><strong>Trabalho e projeto de vida</strong></li>
          <li><strong>Argumentação</strong></li>
          <li><strong>Autoconhecimento e autocuidado</strong></li>
          <li><strong>Empatia e cooperação</strong></li>
          <li><strong>Responsabilidade e cidadania</strong></li>
        </ol>
         ...
         <div className="flex flex-col items-center space-y-6">
            ...
            >
                ...
                Para saber mais sobre as Competências Gerais da BNCC, acesse esta imagem.
                </p>
            </div>

            {/* Imagem que aparece ao clicar */}
            {mostrarImagem && (
                <div className="flex justify-center">
                <Image
